...
public class PopupSubmenu extends JPanel {
    ...
    private static final long serialVersionUID = -4360769668956935037L;
    ...
    private void applyAlignment() {
        ...
        for (Component c : getComponents()) {
            if (c instanceof JButton) {
                ((JButton) c).setHorizontalAlignment(menu.getComponentOrientation().isLeftToRight() ? SwingConstants.LEFT : SwingConstants.RIGHT);
            }
        }
    }
