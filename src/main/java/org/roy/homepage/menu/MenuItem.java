...
public class MenuItem extends JPanel {
    ...
    private static final long serialVersionUID = -7542600846666794050L;
...
//        Color darkColor = FlatUIUtils.getUIColor("Menu.icon.darkColor", Color.red);
        FlatSVGIcon icon = new FlatSVGIcon("org/roy/homepage/menu/icon/" + menuIndex + ".svg");
        FlatSVGIcon.ColorFilter f = new FlatSVGIcon.ColorFilter();
        f.add(Color.decode("#000000"),Color.black,Color.white);
    ...
    private void init() {
        ...
        for (int i = 0; i < menus.length; i++) {
            ...
            menuItem.setHorizontalAlignment(menuItem.getComponentOrientation().isLeftToRight() ? SwingConstants.LEADING : SwingConstants.TRAILING);
            if (i == 0) {
                ...
                menuItem.addActionListener((ActionEvent e) -> {
                    if (menus.length > 1) {
                        if (menu.isMenuFull()) {
                            ...
                            popup.show(MenuItem.this, MenuItem.this.getWidth() + UIScale.scale(5), UIScale.scale(menuItemHeight) / 2);
                        }
                    } else {
        ...
        if (full) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (com instanceof JButton) {
                    ...
                    button.setHorizontalAlignment(getComponentOrientation().isLeftToRight() ? SwingConstants.LEFT : SwingConstants.RIGHT);
                }
            }
        } else {
